...
def data_preprocessing(method, pre_loaded = False):
    if pre_loaded:
        if method == "nn":
            df_train = pd.read_pickle("../Data/Training_set_ver4.pkl")
            df_test = pd.read_pickle("../Data/Test_set_ver4.pkl")
            Y_train = pd.read_pickle("../Data/Training_set_Y_ver4.pkl")
        else: # method == "bayesopt"
            df_train = pd.read_pickle("../Data/Training_set_bayesopt.pkl")
            df_test = pd.read_pickle("../Data/Test_set_bayesopt.pkl")
            Y_train = pd.read_pickle("../Data/Training_set_Y_bayesopt.pkl")
    else:
        ...
        # Using PCA on Vxxx features
            ...
            del df_train["TransactionID"], df_train["TransactionDT"], df_test["TransactionID"], df_test["TransactionDT"]
